...
const CheckoutForm = ({
  ...
  const handleFormSubmit = async ev => {
    ...
    try {
      const {
        data: clientSecret
      } = await axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("/api/payment_intent", {
        amount: price * 100
      });
